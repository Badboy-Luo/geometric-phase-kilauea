...
plt.text(datetime(2018,6,1),0.8,'Broad-scale\ncollapses',fontsize=9,weight='bold',color='peru')
plt.axvspan(datetime(2018,1,1),datetime(2018,1,31),color='k',alpha=0.2,ec='none')
plt.text(datetime(2018,1,5),1.0,'Ref',weight='bold',fontsize=12,color='gray')
plt.grid(ls=':',alpha=0.4)
plt.yticks(np.arange(0.2,2.0,0.2),fontsize=10)
plt.ylim(0.1,1.8)
